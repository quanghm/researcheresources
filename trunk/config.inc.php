...
$i++;
$cfg['Servers'][$i]['host']          = 'cs-grad30.cs.uiuc.edu'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = 'vef';      // MySQL user
...
// set to that server.
 $cfg['ServerDefault'] = 2;              // Default server (0 = no default server)
