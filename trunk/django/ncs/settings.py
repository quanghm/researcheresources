...
ADMINS = (
    ('Admin', 'nghiencuusinh.admin@gmail.com')
)
...
DATABASE_PASSWORD = 't00r'         # Not used with sqlite3.
...
#########################################################
# Dung CURRENT_WORK_DIR de de dang thay doi duong dan
# khi setup tren server hoac develop duoi local

CURRENT_WORK_DIR = '/home/navaro/dev/py/researchsources' #/production/nghiencuusinh.org

MEDIA_ROOT = CURRENT_WORK_DIR + '/django/ncs/media'

SHARE_DIR_ROOT = CURRENT_WORK_DIR + '/share'
...
#########################################################
# Dung DOMAIN_NAME de de dang khi thay doi domain
# khi setup tren server hoac develop duoi local

DOMAIN_NAME = 'http://nghiencuusinh.org' # http://nghiencuusinh.org

SHARE_DIR_URL = DOMAIN_NAME + '/static/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash if there is a path componen:t (optional in other cases).
...
TEMPLATE_DIRS = (
    ...
    #'/home/ncs/org/django/ncs/templates',
    CURRENT_WORK_DIR + '/django/ncs/templates',
)
