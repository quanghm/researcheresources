...
rteImagePath = "<?php echo $strDir;?>/images/";
// Path to insert form popup.
rteHTMLPathInsertForm = "<?php echo $strDir;?>/html/insert_form.html";
// Path to insert checkbox popup.
rteHTMLPathInsertCheckbox = "<?php echo $strDir;?>/html/insert_checkbox.html";
// Path to insert radio button popup.
rteHTMLPathInsertRadiobutton = "<?php echo $strDir;?>/html/insert_radiobutton.html";
// Path to insert text area popup.
rteHTMLPathInsertTextArea = "<?php echo $strDir;?>/html/insert_textarea.html";
// Path to insert submit button popup.
rteHTMLPathInsertSubmit = "<?php echo $strDir;?>/html/insert_submit.html";
// Path to insert image submit button popup.
rteHTMLPathInsertImageSubmit = "<?php echo $strDir;?>/html/insert_image_submit.html";
// Path to reset form button popup.
rteHTMLPathInsertReset = "<?php echo $strDir;?>/html/insert_reset.html";
// Path to insert hidden form field popup.
rteHTMLPathInsertHidden = "<?php echo $strDir;?>/html/insert_hidden.html";
// Path to insert password field popup.
rteHTMLPathInsertPassword = "<?php echo $strDir;?>/html/insert_password.html";
// Path to insert text field popup.
rteHTMLPathInsertText = "<?php echo $strDir;?>/html/insert_text.html";
// Path to insert table popup.
rteHTMLPathInsertTable = "<?php echo $strDir;?>/html/insert_table.html";
// Path to edit table properties popup.
rteHTMLPathEditTable = "<?php echo $strDir;?>/html/edit_table.html";
// Path to insert link popup.
rteHTMLPathInsertLink = "<?php echo $strDir;?>/html/insert_link.html";
// Path to edit link popup.
rteHTMLPathEditLink = "<?php echo $strDir;?>/html/edit_link.html";
// Path to insert image popup.
rteHTMLPathInsertImage = "<?php echo $strDir;?>/html/insert_image.html";
