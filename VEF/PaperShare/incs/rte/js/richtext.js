...
document.write('<textarea id="' + rteFormName + '" name="' + rteFormName + '" style="width:' + rteWidth + ';height:' + rteHeight + ';"></textarea>');} else { 
...
document.write('	cursor:default;'); if (document.all && !window.opera)
{ 
...
document.write('        <td class="rtebg" title="Select All"><div id="selectall" class="rtebtn1"><img src="' + rteImagePath + 'selectall.gif"></div></td>'); if (!document.all || window.opera) { 
document.write('        <td id="spellchecker" class="rtebg" title="Spell Check"><div id="spellcheck" class="rtebtn5"><img src="' + rteImagePath + 'spellcheckgrey.gif"></div></td>');} else { 
...
document.write('						<tr>'); if (rteDesignMode) { 
...
document.write('	</td>'); 
document.write('  </tr>'); 
document.write('</table>'); startRTE(rtePreloadContent); menuBuilder();}
}; 
